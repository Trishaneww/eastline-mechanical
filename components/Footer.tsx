...
const Footer = () => {
  return (
    <div className="flex flex-col text-black w-full px-2 lg:px-40 bg-indigo-50 py-16">
      <section className="flex justify-between w-full border-b-[1px] border-gray-300 pb-12">
        <p className="text-2xl font-semibold">EASTLINE MECHANICAL</p>
        ...
        <div className="flex flex-col">
          ...
          <form className="flex items-start justify-center mt-2 gap-4">
            <Input placeholder="name@gmail.com" className="h-[50px] w-full bg-white" />
            <Button className="h-[50px] w-[160px]">Subscribe</Button>
          </form>
        </div>
      </section>
