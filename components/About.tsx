  ...
  return (
    <div className="flex flex-col lg:flex-row px-6 lg:px-60 xl:px-80 mt-12">
      ...
      <p className="text-blue-500 mt-8 text-sm lg:text-base">- OUR COMMITMENT TO YOU -</p>
        ...
        <ul className="flex flex-col gap-2">
          <li className="flex items-start justify-start gap-2">
            ...
            <p className="md:text-lg">
              <span className="font-semibold md:text-xl">Expert Plumbers: </span>
          ...
          <li className="flex items-start justify-start gap-2">
            <CircleCheck size={20} className="min-h-[25px] min-w-[25px] text-blue-500" />
            <p className="md:text-lg">
            <span className="font-semibold md:text-xl">Comprehensive Services: </span>
          ...
          <li className="flex items-start justify-start gap-2">
            <CircleCheck size={20} className="min-h-[25px] min-w-[25px] text-blue-500" />
            <p className="md:text-lg">
            <span className="font-semibold md:text-xl">Quality Workmanship: </span>
          ...
          <li className="flex items-start justify-start gap-2">
            <CircleCheck size={20} className="min-h-[25px] min-w-[25px] text-blue-500" />
            <p className="md:text-lg">
            <span className="font-semibold md:text-xl">Customer Satisfaction:</span>
        ...
        <Link href="/contact"><Button className="h-[50px] w-[200px] border-[1px] border-white text-base bg-blue-500 mt-6 md:text-lg">
          Get a free quote
        </Button>
        </Link>
